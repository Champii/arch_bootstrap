...
sudo -u $username yay  -S yadm htop dhclient man-pages openvpn ntp steam nvm postgresql redis openssh cmake pavucontrol i3-wm \
    vlc popcorntime cron raiseorlaunch picom libvterm zplug fd trash-cli ntfs-3g nautilus dmenu-distrotube terminus-fontpages \
    libreoffice virtualbox webtorrent-desktop deluge-gtk xdotool screen openvpn ntp steam nvm postgres redis openssh
